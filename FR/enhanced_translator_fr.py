...
import deepl
from constants import DO_NOT_TRANSLATE_TERMS_JSON_FILENAME, TARGET_LANG, TAG_HANDLING
import phunspell
...
def main():
    ...
    query = "Le chef a préparé un délicieux risotto garni de truffe noire et de parmesan."
